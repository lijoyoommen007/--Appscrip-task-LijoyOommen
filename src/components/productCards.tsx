...
const ProductCard: React.FC<ProductCardProps> = ({ imageSrc, productName }) => {
  return (
    <div className="z-20 bg-gray-50 hover:bg-gray-100 shadow-md overflow-hidden w-[47%] h-72 md:w-80 md:h-96 flex flex-col mt-4 transform transition-transform duration-300 hover:scale-100">

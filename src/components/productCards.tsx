...
const ProductCard: React.FC<ProductCardProps> = ({ imageSrc, productName }) => {
  return (
    <div className="z-20 bg-gray-50 hover:bg-gray-100 shadow-md overflow-hidden w-[49%] h-72 md:w-80 md:h-96 flex flex-col mt-4 transform transition-transform duration-300 hover:scale-100">
      ...
      <div className="md:p-4 pl-3  flex-grow flex flex-col justify-between">
        ...
        <div className="flex items-center justify-between md:mt-2 mt-1 mb-2">
          <p className="w-[90%] md:w-auto text-xs md:text-sm text-gray-600 transition-transform duration-300"><span className="underline cursor-pointer md:text-sm text-xs">Sign in</span>{" "}or Create an account to see the pricing</p>

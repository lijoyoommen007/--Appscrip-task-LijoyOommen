...
const CustomDropdown: React.FC<CustomDropdownProps> = ({ options, filterKey, filters, setFilters, heading }) => {
    ...
    return (
        <div className="custom-dropdown text-black border-b-2 mt-5">
            <div className="px-12 font-bold text-lg flex justify-between items-center" onClick={handleToggleDropdown}>{heading} {isOpen ? <IoIosArrowUp size={20} /> : <IoIosArrowDown size={20} />} </div>
